...
export const Section = (props: {
  ...
  <div className={cn('px-3 py-16', props.className)}>
    {(props.title || props.subtitle || props.description) && (
      <div className="mx-auto mb-12 max-w-(--breakpoint-lg) text-center">
        {props.subtitle && (
        ...
        {props.title && <div className="mt-1 text-5xl font-bold">{props.title}</div>}
    ...
    <div className="mx-auto max-w-(--breakpoint-xl)">{props.children}</div>
  </div>
)
